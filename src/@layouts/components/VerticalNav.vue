  ...
  <Component :is="props.tag" ref="refNav" class="layout-vertical-nav" :class="[
    ...
    <div class="nav-header">
      <slot name="nav-header">
        <RouterLink to="/admin/dashboard" class="app-logo d-flex align-center gap-x-3 app-title-wrapper">
          <div class="d-flex">
            <img :src="logo" alt="Logo" class="app-logo rounded" style="width: 40px;" />
          </div>
